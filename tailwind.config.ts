...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      height: {
        stage: "520px",
        // Та же сцена в hero лендинга, но по росту экрана: от прежних 384px до 520px.
        // 17.5rem — шапка hero над сценой и переключатель с подсказкой под ней: на
        // ноутбуке 1366×768 фиксированные 520px увели бы их под сгиб.
        "stage-hero": "clamp(24rem, calc(100vh - 17.5rem), 32.5rem)",
      },
      spacing: {
